  ...
  return (
    <AppShell>
      <main className="mx-auto max-w-4xl px-4 py-8">
        {profile && <>
          <div className="flex items-center gap-5"><div className="grid h-24 w-24 place-items-center rounded-full bg-[#1cb0f6] text-3xl font-black text-white">{profile.user.avatar}</div><div><h1 className="text-4xl font-black text-slate-800">{profile.user.display_name}</h1><p className="font-bold text-slate-400">@{profile.user.username}</p></div></div>
